...
public class LyThuyetChuoi {
    ...
    /*
         ...
         * 11. Tách chuỗi .Split (Chuyển từ chuỗi string sang mảng Array)
            ...
            kết quả arrListStr[0]='các hàm xử lý chuỗi' 
            và arrListStr[1]='xử lý chuỗi trong java'
...
//        xuLyChuoi();
//họ tên chỉ chứa ký tự chữ 
//+: có 1 hoặc nhiều ký tự
//cách 1: ^[a-zA-Z ]+$ => đưa luôn dấu cách
//cách 2: ^[a-zA-Z\\s]+$ => sủ dụng \\s
        String hoTen= kiemTraDauVao("họ tên", "^[a-zA-Z\\s]+$");
        System.out.println("Họ tên: "+ hoTen);
        //tuổi chỉ chứa số
        String tuoi = kiemTraDauVao("tuổi", "^[0-9]+$");
        //tự ép kiểu
        System.out.println("Tuổi: "+ tuoi);
        //sdt: bắt đầu bằng số 0, số thứ 2 phải khác 0, độ dài 10 số
    ...
    public static String kiemTraDauVao(String msg, String pattern){
        ...
        //Kiểm tra dữ liệu nhập có hợp lệ hay ko? => yêu cầu nhập lại hợp lệ
        String input;
        do {
            System.out.println("Mời nhập "+ msg+": ");
            input= sc.nextLine();
    ...
    public static void xuLyChuoi() {
        ...
        System.out.println("Viet thuong: " + hoVaTen.toLowerCase());
        System.out.println("Viet hoa: " + hoVaTen.toUpperCase());
        ...
        if(hoVaTen.toLowerCase().contains("nguyen")){
            System.out.println("Ho ten chua tu Nguyen");
        }
        //replace, substring, split, join, remove -> tự làm
    }
}
